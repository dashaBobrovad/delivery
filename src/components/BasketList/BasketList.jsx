...
function BasketList(params) {
    return (<div className="container container_cart">
      ...
      <div className="content__items">
        <div className={s.item}>
          ...
          <div className={s.item__count}>
            <div className={cx("button button--outline button--circle", s.item__count_minus)}>
              <svg
                width="10"
                height="10"
                viewBox="0 0 10 10"
            ...
            <b>2</b>
            <div className={cx("button button--outline button--circle", s.item__count_plus)}>
              <svg
                width="10"
                height="10"
                viewBox="0 0 10 10"
