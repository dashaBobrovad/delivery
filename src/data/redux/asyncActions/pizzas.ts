import { get, PizzaAction, setIsPizzaListLoaded, SetIsPizzaListLoadedAction } from "../features/pizzas/pizzasSlice";
...
const fetchPizzas = () => async (dispatch: Dispatch<PizzaAction | SetIsPizzaListLoadedAction>) => {
